...
<template>
  <main class="game-screen">
    ...
    <section class="game-stage" aria-label="游戏区域">
      ...
      />
      <span class="game-stage__count" aria-live="polite">剩余 {{ store.aliveCount }}</span>
    </section>
    ...
    <footer class="game-tools">
      ...
      <div class="game-tools__actions">
        ...
        <button class="tool-button tool-button--accent" type="button" :disabled="store.hintsRemaining === 0" @click="hint">
          <Lightbulb :size="19" aria-hidden="true" />
          <span>提示 <b>{{ store.hintsRemaining }}</b></span>
        </button>
        <button class="tool-button" type="button" title="重新开始" @click="restart">
