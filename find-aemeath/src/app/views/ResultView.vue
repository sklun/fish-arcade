...
<template>
  <main class="result-screen" :class="{ 'result-screen--failure': !success }">
    <div class="result-card">
      ...
      <button v-if="success" class="primary-button primary-button--large" type="button" @click="next">下一关 <ArrowRight :size="19" /></button>
      <button v-else class="primary-button primary-button--large" type="button" @click="retry"><RotateCcw :size="19" />再次尝试</button>
      <div class="result-links">
        <a class="text-button platform-link" href="/"><Gamepad2 :size="16" />返回游戏中心</a>
      </div>
    </div>
  </main>
</template>
